...
public class WithMethodFactoryTest {
    ...
    public void stringMethod() throws Exception {
        ...
        WithMethod actual = TestUtils.createWithMethod("day", Target.class, BUILDER_PACKAGE, classesToIgnore);
    ...
    public void booleanMethod() throws Exception {
        ...
        WithMethod actual = TestUtils.createWithMethod("hungry", Target.class, BUILDER_PACKAGE, classesToIgnore);
        assertWithMethodsEqual(expected, actual);
    }
    ...
    public void beanWithBooleanPrimitive() throws Exception {
        ...
        WithMethod actual = TestUtils.createWithMethod("theBoolean", BooleanPropertyBean.class, BUILDER_PACKAGE, classesToIgnore);
        assertWithMethodsEqual(expected, actual);
    }
    ...
    public void listOfStrings() throws Exception {
        ...
        WithMethod actual = TestUtils.createWithMethod("months", Target.class, BUILDER_PACKAGE, classesToIgnore);
        assertWithMethodsEqual(expected, actual);
    }
    ...
    public void builderMethod() throws Exception {
        ...
        WithMethod actual = TestUtils.createWithMethod("delegate", Target.class, BUILDER_PACKAGE, classesToIgnore);
        assertWithMethodsEqual(expected, actual);
    }
    ...
    public void listOfBuilders() throws Exception {
        ...
        WithMethod actual = TestUtils.createWithMethod("persons", Target.class, BUILDER_PACKAGE, classesToIgnore);
        assertWithMethodsEqual(expected, actual);
    }
    ...
    public void singularBuilderWithFieldNameEndingWithDoubleS() throws Exception {
        ...
        WithMethod actual = TestUtils.createWithMethod("address", Target.class, BUILDER_PACKAGE, classesToIgnore);
        assertWithMethodsEqual(expected, actual);
    }
    ...
    public void listOfBuildersWithFieldNameEndingWithSses() throws Exception {
        ...
        WithMethod actual = TestUtils.createWithMethod("hostesses", Target.class, BUILDER_PACKAGE, classesToIgnore);
        assertWithMethodsEqual(expected, actual);
    }
    ...
    public void singularBuilderWithFieldNameEndingWithSe() throws Exception {
        ...
        WithMethod actual = TestUtils.createWithMethod("house", Target.class, BUILDER_PACKAGE, classesToIgnore);
        assertWithMethodsEqual(expected, actual);
    }
    ...
    public void listOfBuildersWithFieldNameEndingWithSes() throws Exception {
        ...
        WithMethod actual = TestUtils.createWithMethod("houses", Address.class, BUILDER_PACKAGE, classesToIgnore);
        assertWithMethodsEqual(expected, actual);
    }
    ...
    public void subClassFields() throws Exception {
        ...
        WithMethod actual = TestUtils.createWithMethod("night", SubTarget.class, BUILDER_PACKAGE, classesToIgnore);
        assertWithMethodsEqual(expected, actual);
    }
    ...
    public void inherittedFields() throws Exception {
        ...
        WithMethod expected = new WithMethod("Day", "java.lang.String", "day", false, false, null, null, null, null, false, null);
        WithMethod actual = TestUtils.createWithMethod("day", SubTarget.class, BUILDER_PACKAGE, classesToIgnore);
        assertWithMethodsEqual(expected, actual);
    }
    ...
    public void listPropertyWithAddMethod() throws Exception {
        ...
        WithMethod actual = TestUtils.createWithMethod("strings", InitialisedListPropertyWithAddMethod.class, BUILDER_PACKAGE, classesToIgnore);
        assertWithMethodsEqual(expected, actual);
    }
    ...
    public void listPropertyWithSetListMethod() throws Exception {
        ...
        WithMethod actual = TestUtils.createWithMethod("strings", InitialisedListPropertyWithSetListMethod.class, BUILDER_PACKAGE, classesToIgnore);
        assertWithMethodsEqual(expected, actual);
    }
    ...
    public void listPropertyWithAddMethodAndSetListMethod() throws Exception {
        ...
        WithMethod expected = new WithMethod("String", "java.lang.String", "string", true, false, "getStrings", "setStrings", "java.util.ArrayList", "addString", false, null);
        WithMethod actual = TestUtils.createWithMethod("strings", InitialisedListPropertyWithAddMethodAndSetListMethod.class, BUILDER_PACKAGE, classesToIgnore);
        assertWithMethodsEqual(expected, actual);
    }
    ...
    public void listPropertyWithSetListMethodAndGetListReturnsNull() throws Exception {
        ...
        WithMethod actual = TestUtils.createWithMethod("strings", NullListPropertyWithSetListMethod.class, BUILDER_PACKAGE, classesToIgnore);
        assertWithMethodsEqual(expected, actual);
    }
    ...
    public void setPropertyWithSetSetMethodAndGetSetReturnsNull() throws Exception {
        ...
        WithMethod actual = TestUtils.createWithMethod("strings", NullSetPropertyWithSetSetMethod.class, BUILDER_PACKAGE, classesToIgnore);
        assertWithMethodsEqual(expected, actual);
    }
    ...
    public void queuePropertyWithSetQueueMethodAndGetQueueReturnsNull() throws Exception {
        ...
        WithMethod actual = TestUtils.createWithMethod("strings", NullQueuePropertyWithSetQueueMethod.class, BUILDER_PACKAGE, classesToIgnore);
        assertWithMethodsEqual(expected, actual);
    }
    ...
    public void arrayOfStringsProperty() throws Exception {
        ...
        WithMethod actual = TestUtils.createWithMethod("strings", ArrayOfStringsPropertyWithSetArrayMethod.class, BUILDER_PACKAGE, classesToIgnore);
        assertWithMethodsEqual(expected, actual);
    }
    ...
    public void beanWhereFieldNameDiffersFromBeanProperteyNameFromAccessors() throws Exception {
        ...
        WithMethod actual = TestUtils.createWithMethod("wibble", BeanWhereFieldNameDiffersFromBeanProperteyNameFromAccessors.class, BUILDER_PACKAGE, classesToIgnore);
        assertWithMethodsEqual(expected, actual);
    }
    ...
    public void beanWithTopLevelEnumProperty() throws Exception {
        ...
        WithMethod actual = TestUtils.createWithMethod("topLevelEnum", BeanWithTopLevelEnumProperty.class, BUILDER_PACKAGE, classesToIgnore);
        assertWithMethodsEqual(expected, actual);
    }
    ...
    public void beanWithNestedEnum() throws Exception {
        ...
        WithMethod actual = TestUtils.createWithMethod("nestedEnum", BeanWithNestedEnum.class, BUILDER_PACKAGE, classesToIgnore);
        assertWithMethodsEqual(expected, actual);
    }
    ...
    public void beanWithThreeEDimensionalIntArray() throws Exception {
        ...
        WithMethod actual = TestUtils.createWithMethod("threeDimenstionalIntArray", BeanWithMultiDimensionalArrayOfPrimitives.class, BUILDER_PACKAGE, classesToIgnore);
        assertWithMethodsEqual(expected, actual);
    }
    ...
    public void beanWithTwoEDimensionalBooleanArray() throws Exception {
        ...
        WithMethod actual = TestUtils.createWithMethod("twoDimensionalBooleanArray", BeanWithMultiDimensionalArrayOfPrimitives.class, BUILDER_PACKAGE, classesToIgnore);
        assertWithMethodsEqual(expected, actual);
    }
